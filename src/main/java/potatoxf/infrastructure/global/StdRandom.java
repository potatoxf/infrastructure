...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        Std.println("seed = " + StdRandom.getSeed());
        for (int i = 0; i < n; i++) {
            Std.printf("%2d ", uniform(100));
            Std.printf("%8.5f ", uniform(10.0, 99.0));
            Std.printf("%5b ", bernoulli(0.5));
            Std.printf("%7.5f ", gaussian(9.0, 0.2));
            Std.printf("%1d ", discrete(probabilities));
            Std.printf("%1d ", discrete(frequencies));
            Std.printf("%11d ", uniform(100000000000L));
            StdRandom.shuffle(a);
            for (String s : a)
                Std.print(s);
            Std.println();
