...
/**
 * {@link ConcurrentNavigableMap}装饰器
 * <p/>
 * Create Time:2024-04-27
 *
 * @author potatoxf
 */
public interface DelegateConcurrentNavigableMap<K, V> extends DelegateConcurrentMap<K, V>, DelegateNavigableMap<K, V>, ConcurrentNavigableMap<K, V> {
    /**
     * 被装饰
     *
     * @return {@code ConcurrentNavigableMap<K,V>}
     */
    ConcurrentNavigableMap<K, V> delegate();
     ...
     */
    @Override
    default ConcurrentNavigableMap<K, V> subMap(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive) {
     ...
     */
    @Override
    default ConcurrentNavigableMap<K, V> headMap(K toKey, boolean inclusive) {
     ...
     */
    @Override
    default ConcurrentNavigableMap<K, V> tailMap(K fromKey, boolean inclusive) {
