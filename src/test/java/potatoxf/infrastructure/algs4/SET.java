...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    public static void main(String[] args) {
        ...
        Std.println(set.contains("www.cs.princeton.edu"));
        Std.println(!set.contains("www.harvardsucks.com"));
        Std.println(set.contains("www.simpsons.com"));
        Std.println();

        Std.println("ceiling(www.simpsonr.com) = " + set.ceiling("www.simpsonr.com"));
        Std.println("ceiling(www.simpsons.com) = " + set.ceiling("www.simpsons.com"));
        Std.println("ceiling(www.simpsont.com) = " + set.ceiling("www.simpsont.com"));
        Std.println("floor(www.simpsonr.com)   = " + set.floor("www.simpsonr.com"));
        Std.println("floor(www.simpsons.com)   = " + set.floor("www.simpsons.com"));
        Std.println("floor(www.simpsont.com)   = " + set.floor("www.simpsont.com"));
        Std.println();
