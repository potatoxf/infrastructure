...
public class Complex {
    ...
    public static void main(String[] args) {
        ...
        Std.println("a            = " + a);
        Std.println("b            = " + b);
        Std.println("Re(a)        = " + a.re());
        Std.println("Im(a)        = " + a.im());
        Std.println("b + a        = " + b.plus(a));
        Std.println("a - b        = " + a.minus(b));
        Std.println("a * b        = " + a.times(b));
        Std.println("b * a        = " + b.times(a));
        Std.println("a / b        = " + a.divides(b));
        Std.println("(a / b) * b  = " + a.divides(b).times(b));
        Std.println("conj(a)      = " + a.conjugate());
        Std.println("|a|          = " + a.abs());
        Std.println("tan(a)       = " + a.tan());
    }
