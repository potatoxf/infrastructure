...
public class Polynomial {
    ...
    public static void main(String[] args) {
        ...
        Std.println("zero(x)     = " + zero);
        Std.println("p(x)        = " + p);
        Std.println("q(x)        = " + q);
        Std.println("p(x) + q(x) = " + r);
        Std.println("p(x) * q(x) = " + s);
        Std.println("p(q(x))     = " + t);
        Std.println("p(x) - p(x) = " + u);
        Std.println("0 - p(x)    = " + zero.minus(p));
        Std.println("p(3)        = " + p.evaluate(3));
        Std.println("p'(x)       = " + p.differentiate());
        Std.println("p''(x)      = " + p.differentiate().differentiate());
    }
