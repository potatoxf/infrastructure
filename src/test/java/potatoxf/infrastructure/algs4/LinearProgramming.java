...
public class LinearProgramming {
    ...
    private boolean isPrimalFeasible(double[][] A, double[] b) {
        ...
        for (int j = 0; j < x.length; j++) {
            if (x[j] < 0.0) {
                Std.println("x[" + j + "] = " + x[j] + " is negative");
                return false;
            }
        }
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (sum > b[i] + EPSILON) {
                Std.println("not primal feasible");
                Std.println("b[" + i + "] = " + b[i] + ", sum = " + sum);
                return false;
            }
        }
        return true;
    ...
    private boolean isDualFeasible(double[][] A, double[] c) {
        ...
        for (int i = 0; i < y.length; i++) {
            if (y[i] < 0.0) {
                Std.println("y[" + i + "] = " + y[i] + " is negative");
                return false;
            }
        }
        ...
        for (int j = 0; j < n; j++) {
            ...
            if (sum < c[j] - EPSILON) {
                Std.println("not dual feasible");
                Std.println("c[" + j + "] = " + c[j] + ", sum = " + sum);
                return false;
            }
        }
        return true;
    ...
    private boolean isOptimal(double[] b, double[] c) {
        ...
        if (Math.abs(value - value1) > EPSILON || Math.abs(value - value2) > EPSILON) {
            Std.println("value = " + value + ", cx = " + value1 + ", yb = " + value2);
            return false;
        }
    ...
    private void show() {
        ...
        for (int i = 0; i < m; i++)
            if (basis[i] < n) Std.println("x_" + basis[i] + " = " + a[i][m + n]);
        Std.println();
    }
