...
import potatoxf.infrastructure.global.StdDraw;
...
public class CollisionSystem {
    ...
    public static void main(String[] args) {
        ...
        // or read from standard input
            ...
            particles = new Particle[n];
            for (int i = 0; i < n; i++) {
                double rx = Std.readDouble();
                double ry = Std.readDouble();
                double vx = Std.readDouble();
                double vy = Std.readDouble();
                double radius = Std.readDouble();
                double mass = Std.readDouble();
                int r = Std.readInt();
                int g = Std.readInt();
                int b = Std.readInt();
