...
public class GraphGenerator {
    ...
    public static void main(String[] args) {
        ...
        Std.println("Erdos-Renyi");
        double p = (double) E / (V * (V - 1) / 2.0);
        Std.println(simple(V, p));
        Std.println();

        Std.println("complete bipartite");
        Std.println(completeBipartite(V1, V2));
        Std.println();

        Std.println("bipartite");
        Std.println(bipartite(V1, V2, E));
        Std.println();

        Std.println("Erdos Renyi bipartite");
        double q = (double) E / (V1 * V2);
        Std.println(bipartite(V1, V2, q));
        Std.println();
        ...
        Std.println("4-regular");
        Std.println(regular(V, 4));
        Std.println();
