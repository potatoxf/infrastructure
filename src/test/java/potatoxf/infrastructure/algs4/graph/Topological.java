 ...
 *  Dependencies: Graph.java DepthFirstOrder.java DirectedCycle.java
 *                Graph.java EdgeWeightedDirectedCycle.java
 *                SymbolDigraph.java
...
//    }
    ...
    public static void main(String[] args) {
        ...
        Topological topological = new Topological(sg);
