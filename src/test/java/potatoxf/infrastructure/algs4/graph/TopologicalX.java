...
public class TopologicalX {
    ...
    public static void main(String[] args) {
        ...
        Graph G1 = DigraphGenerator.dag(V, E);

        // corresponding edge-weighted digraph
        Graph G2 = new Graph(V, true);
        for (int v = 0; v < G1.vertexCount(); v++)
            for (int w : G1.adjacencyVertex(v))
                G2.addEdge(new Graph.Edge(v, w, 0.0));
        ...
        if (!topological1.hasOrder()) {
            Std.println("Not a DAG");
        }

        // or give topologial sort
        else {
            Std.print("Topological order: ");
    ...
    private boolean check(Graph G) {
        ...
        if (hasOrder()) {
            ...
            boolean[] found = new boolean[G.vertexCount()];
