...
import potatoxf.infrastructure.algs4.SET;
...
public class DigraphGenerator {
     ...
     */
    public static Graph dag(int V, int E) {
     ...
     */
    public static Graph tournament(int V) {
        Graph G = new Graph(V, true);
        for (int v = 0; v < G.vertexCount(); v++) {
            for (int w = v + 1; w < G.vertexCount(); w++) {
     ...
     */
    public static Graph rootedInDAG(int V, int E) {
        if (E > (long) V * (V - 1) / 2) throw new IllegalArgumentException("Too many edges");
     ...
     */
    public static Graph rootedOutDAG(int V, int E) {
        if (E > (long) V * (V - 1) / 2) throw new IllegalArgumentException("Too many edges");
        if (E < V - 1) throw new IllegalArgumentException("Too few edges");
        Graph G = new Graph(V, true);
        SET<Edge> set = new SET<Edge>();
     ...
     */
    public static Graph rootedInTree(int V) {
     ...
     */
    public static Graph rootedOutTree(int V) {
     ...
     */
    public static Graph strong(int V, int E, int c) {
        if (c >= V || c <= 0)
    ...
    public static void main(String[] args) {
        ...
        Std.println("complete graph");
        Std.println(complete(V));
        Std.println();

        Std.println("simple");
        Std.println(simple(V, E));
        Std.println();
        ...
        Std.println("Eulierian path");
        Std.println(eulerianPath(V, E));
        Std.println();

        Std.println("Eulierian cycle");
        Std.println(eulerianCycle(V, E));
        Std.println();

        Std.println("binary tree");
        Std.println(binaryTree(V));
        Std.println();

        Std.println("tournament");
        Std.println(tournament(V));
        Std.println();
        ...
        Std.println("rooted-in DAG");
        Std.println(rootedInDAG(V, E));
        Std.println();

        Std.println("rooted-out DAG");
        Std.println(rootedOutDAG(V, E));
        Std.println();

        Std.println("rooted-in tree");
        Std.println(rootedInTree(V));
        Std.println();

        Std.println("rooted-out DAG");
        Std.println(rootedOutTree(V));
        Std.println();
    }
