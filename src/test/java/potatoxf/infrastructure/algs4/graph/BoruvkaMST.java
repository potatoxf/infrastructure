...
import potatoxf.infrastructure.algs4.Bag;
...
public class BoruvkaMST {
    ...
    private final Bag<Graph.Edge> mst = new Bag<Graph.Edge>();    // edges in MST
    ...
    public BoruvkaMST(Graph G) {
        ...
        for (int t = 1; t < G.vertexCount() && mst.size() < G.vertexCount() - 1; t = t + t) {

            // foreach tree in forest, find closest edge
            // if edge weights are equal, ties are broken in favor of first edge in G.edges()
            Graph.Edge[] closest = new Graph.Edge[G.vertexCount()];
    ...
    private static boolean less(Graph.Edge e, Graph.Edge f) {
