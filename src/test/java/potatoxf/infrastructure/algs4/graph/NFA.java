 ...
 *  Dependencies: Stack.java Bag.java Graph.java DirectedDFS.java
 *
...
public class NFA {
    ...
    private final Graph graph;     // digraph of epsilon transitions
    ...
    public static void main(String[] args) {
        ...
        Std.println(nfa.recognizes(txt));
    }
