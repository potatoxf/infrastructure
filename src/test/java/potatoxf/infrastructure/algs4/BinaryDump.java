...
import potatoxf.infrastructure.global.BinaryStdIn;
    ...
    public static void main(String[] args) {
        ...
        for (count = 0; !BinaryStdIn.isEmpty(); count++) {
            if (bitsPerLine == 0) {
                ...
                continue;
            } else if (count != 0 && count % bitsPerLine == 0) Std.println();
            if (BinaryStdIn.readBoolean()) Std.print(1);
            else Std.print(0);
        }
        if (bitsPerLine != 0) Std.println();
        Std.println(count + " bits");
    }
}
