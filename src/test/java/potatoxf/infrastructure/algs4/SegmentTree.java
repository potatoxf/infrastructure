    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if ((!line[0].equals("set") && !line[0].equals("init")) && st == null) {
                Std.println("Segment Tree not initialized");
                continue;
            }
            int[] array;
            if (line[0].equals("set")) {
                ...
                Std.printf("Sum from %d to %d = %d%n", arg1, arg2, st.rsq(arg1, arg2));
            } else if (line[0].equals("rmq")) {
                Std.printf("Min from %d to %d = %d%n", arg1, arg2, st.rMinQ(arg1, arg2));
            } else {
