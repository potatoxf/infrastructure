...
public class SuffixArrayX {
    ...
    public static void main(String[] args) {
        String s = Std.readLine().replaceAll("\n", " ").trim();
        ...
        for (int i = 0; check && i < s.length(); i++) {
            if (suffix1.index(i) != suffix2.index(i)) {
                Std.println("suffix1(" + i + ") = " + suffix1.index(i));
                Std.println("suffix2(" + i + ") = " + suffix2.index(i));
        ...
        Std.println("  i ind lcp rnk  select");
        Std.println("---------------------------");
