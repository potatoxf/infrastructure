...
public class TrieSET implements Iterable<String> {
    ...
    public static void main(String[] args) {
        ...
        Std.println(set.longestPrefixOf("shellsort"));
        Std.println();

        Std.println("longestPrefixOf(\"xshellsort\"):");
        Std.println(set.longestPrefixOf("xshellsort"));
        Std.println();
        ...
        Std.println("keysWithPrefix(\"shortening\"):");
