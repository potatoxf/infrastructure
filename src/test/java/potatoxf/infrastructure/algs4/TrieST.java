    ...
    public static void main(String[] args) {
        ...
        if (st.size() < 100) {
            ...
            for (String key : st.keys()) {
                Std.println(key + " " + st.get(key));
            }
            Std.println();
        }

        Std.println("longestPrefixOf(\"shellsort\"):");
        Std.println(st.longestPrefixOf("shellsort"));
        Std.println();

        Std.println("longestPrefixOf(\"quicksort\"):");
        Std.println(st.longestPrefixOf("quicksort"));
        Std.println();

        Std.println("keysWithPrefix(\"shor\"):");
        for (String s : st.keysWithPrefix("shor"))
            Std.println(s);
        Std.println();

        Std.println("keysThatMatch(\".he.l.\"):");
