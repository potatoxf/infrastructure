...
public class BTree<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        Std.println("cs.princeton.edu:  " + st.get("www.cs.princeton.edu"));
        Std.println("hardvardsucks.com: " + st.get("www.harvardsucks.com"));
        Std.println("simpsons.com:      " + st.get("www.simpsons.com"));
        Std.println("apple.com:         " + st.get("www.apple.com"));
        Std.println("ebay.com:          " + st.get("www.ebay.com"));
        Std.println("dell.com:          " + st.get("www.dell.com"));
        Std.println();

        Std.println("size:    " + st.size());
        Std.println("height:  " + st.height());
        Std.println(st);
        Std.println();
    }
